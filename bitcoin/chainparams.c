...
const struct chainparams networks[] = {
    ...
    {.network_name = "litecoin",
     ...
     .bip32_key_version = {.bip32_pubkey_version = BIP32_VER_MAIN_PUBLIC,
			   .bip32_privkey_version = BIP32_VER_MAIN_PRIVATE},
     .is_elements = false},
    {.network_name = "sugarchain",
     .bip173_name = "sugar",
     .bip70_name = "main",
     .genesis_blockhash = {{{.u.u8 = {0xbc, 0x0a, 0x1b, 0x81, 0x1b, 0x38, 0x83, 
				      0x3a, 0x4f, 0x9d, 0xf7, 0x04, 0x82, 0x8c,
				      0x1d, 0xbc, 0xca, 0xb7, 0x78, 0x4c, 0x52,
				      0xfa, 0xad, 0xfe, 0x99, 0x5f, 0xb7, 0xdb,
				      0xc2, 0xae, 0x5e, 0x7d}}}},
     .rpc_port = 34229,
     .cli = "sugarchain-cli",
     .cli_args = NULL,
